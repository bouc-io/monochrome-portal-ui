...
export const ChatSidebar = ({
  ...
  const [currentModel, setCurrentModel] = useState(
    selectedModel || availableModels[0]?.id || "llama3.2",
  );
  ...
  const currentModelData =
    availableModels.find((model) => model.id === currentModel) ||
    availableModels[0];
        ...
        <SidebarHeader className="p-4 space-y-3 bg-background">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="w-full justify-between p-2 h-auto bg-background hover:bg-accent text-foreground"
              >
                <div className="text-left flex-1 min-w-0 mr-2">
                  <p className="font-medium text-sm truncate">
                    {currentModelData?.name || "Unknown Model"}
                  </p>
                        ...
                        <div className="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <DropdownMenu>
                            ...
                            >
                              <DropdownMenuItem
                                onClick={(e) =>
                                  handleChatAction(chat.id, "rename", e)
                                }
                              ...
                              <DropdownMenuItem
                                onClick={(e) =>
                                  handleChatAction(chat.id, "delete", e)
                                }
