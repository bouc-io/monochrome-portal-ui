...
import { Edit2, Trash2, Power, PowerOff, Clock, Tag, AlertCircle } from "lucide-react";
...
import { Memory, categoryColors, categoryIcons, importanceColors } from "@/lib/memoryApi";
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge 
              ...
              className={cn(
                "capitalize",
                memory.importance === 'critical' && "border-red-500 text-red-600",
                memory.importance === 'high' && "border-orange-500 text-orange-600",
                memory.importance === 'medium' && "border-yellow-500 text-yellow-600",
                memory.importance === 'low' && "border-muted-foreground text-muted-foreground"
              )}
            >
          ...
          <div className="flex items-center gap-1">
            ...
            >
              {memory.isActive ? <Power className="w-4 h-4" /> : <PowerOff className="w-4 h-4" />}
            </Button>
            <Button
              variant="ghost"
              size="icon"
